...
describe('GET MY BOOKMARK', () => {
    ...
    test('get bookmark with empty token /401', async () => {
        let response = await request(app)
        .get('/bookmarks')
    ...
    test('get bookmark with no Bearer /401', async () => {
        let response = await request(app)
        .get('/bookmarks')
...
describe('ADD BOOKMARK', () => {
    ...
    test('add bookmark with no token', async() => {
        let response = await request(app)
        .post('/bookmarks?key=2025/02/12/lenovo-legion-go-s-12022025')
        .set('Authorization', `Bearer`)
        expect(response.status).toEqual(401)
    ...
    test('add bookmark with no Bearer', async() => {
        let response = await request(app)
        .post('/bookmarks?key=2025/02/12/lenovo-legion-go-s-12022025')
        .set('Authorization', `${tokenUser1}`)
        expect(response.status).toEqual(401)
